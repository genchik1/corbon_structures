...
if __name__ == '__main__':
    ...
    e1 = (h*V/1-b_p*b_m)*(kx*(b_p+b_m)*(1/np.tan(kx*d))+(b_p-b_m)*ky)


    df5_1 = intersections(pd.DataFrame({'kx':kx, 'ky':ky, 'e1':e1, 'e2':E1}))
    df5_1.to_csv('result/np_df1', sep='\t', index=None, header=None)
